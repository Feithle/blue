...
<div class="div-leftside">
    ...
    <div class="left-nav">
        <div class="left-nav-group">
            ...
            <h2>菜单</h2>
            <ul>
                <li><a class="active" href="/innovate/pages/conditions.html">分类浏览</a></li>
...
basicMessages=(List<BasicMessage>)request.getAttribute("users");
 %>
 <h3 style="margin-left:27%;color:#9acfea">分类情况</h3>
<span></span>
<span style="margin-left: 55%">————<%  
   ...
   out.println("数据更新至："+time);  
     %> </span>
	<table border="1px" width="800px" id="txt">

	<tr>
		<td align="center">平台名称</td>
		<td align="center">平台编号</td>
