			...
			lis[i].onclick=function(){
				for (var ii=0;ii<lis.length ;ii++ )
				{
					if (this == lis[ii])
					{
						...
						document.getElementById("county1").value=sheng;
					...
					lis[ii].onclick=function(){
						for (var jj=0; jj<lis.length; jj++)
						{
							...
							{	
								...
								document.querySelector('.areaxs').innerHTML=qu;
								document.getElementById("county2").value=shi;
							...
							lis[ii].onclick=function(){
								for (var jj=0; jj<lis.length; jj++)
								{
									if (this == lis[jj])
									{
										...
										var qu=lis[jj].getAttribute('value');
										document.querySelector('.quancity').style.display="none";
										document.getElementById("county3").value=qu;
